...
namespace Website_GYM.Controllers
{
    public class KHUYENMAIsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "mact,tenct,noidung,doituong")] KHUYENMAI kHUYENMAI)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "mact,tenct,noidung,doituong")] KHUYENMAI kHUYENMAI)
        {
            if (ModelState.IsValid)
            {
